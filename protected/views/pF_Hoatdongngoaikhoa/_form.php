...
<div class='widget'>
	...
	<div class="widget-head">
        <h3 class="heading">Thêm Hoạt Động Ngoại Khóa</h3>
    </div>	
		<div class="widget-body innerAll inner-2x">
			<div class="row innerLR">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
					<?php echo $form->textField($model,'pf_ngay_bat_dau',array('class'=>'form-control','rows'=>6, 'cols'=>50)); ?>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
					<?php echo $form->textField($model,'pf_ngay_ket_thuc',array('class'=>'form-control','rows'=>6, 'cols'=>50)); ?>
					</div>
