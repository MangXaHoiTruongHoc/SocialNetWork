...
<div class="widget hdnk<?php echo $model->pf_ma_hdnk ?>">
	<table class="table">
		<tbody>
	        <tr >
	            <th class="center col-md-4"><?php echo $model->getAttributeLabel('pf_ten_hoat_dong')?></th>
	        ...
	        <tr >
	            <th class="center"><?php echo $model->getAttributeLabel('pf_ngay_bat_dau')?></th>
	            <td><?php echo $model->pf_ngay_bat_dau?></td>
	        </tr>
	        <tr >
	            <th class="center"><?php echo $model->getAttributeLabel('pf_ngay_ket_thuc')?></th>
	            <td><?php echo $model->pf_ngay_ket_thuc?></td>
	        </tr>
	        <tr >
	            <th class="center"><?php echo $model->getAttributeLabel('pf_vai_tro')?></th>
	            <td><?php echo $model->pf_vai_tro?></td>
	        </tr>
	        <tr >
	            <th class="center"><?php echo $model->getAttributeLabel('pf_mo_ta')?></th>
	            <td><?php echo $model->pf_mo_ta?></td>
	        </tr>
	       <tr>
	       <td colspan="2" style="width:633px;height:175px">
