...
<head>
	...
	**********************************************************
    ...
    <![endif]-->
    <script src="../assets/components/library/jquery/jquery.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/library/jquery/jquery-migrate.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/library/modernizr/modernizr.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/plugins/less-js/less.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/modules/admin/charts/flot/assets/lib/excanvas.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/plugins/browser/ie/ie.prototype.polyfill.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script>
...
<body class=" menu-right-hidden">
    ...
    <div class="container-fluid ">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <span class="pull-left innerR">
                                        <img src="../assets/images/people/35/16.jpg"
                                ...
                                <div class="loaded hide2">
                                    ...
                                    <div class="widget gridalicious-item not-responsive">
                                        ...
                                        <div class="border-top innerAll">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <a href="#">
                                                    <img src="../assets/images/people/35/13.jpg"
                                    ...
                                    <div class="widget gridalicious-item not-responsive ">
                                        ...
                                        <div class="innerAll">
                                            ...
                                            <div class="innerB">
                                                <a href="">
                                                    <img src="../assets/images/social/100/1.jpg"
                                                    alt="" class="img-post display-block-inline"
                                                    />
                                                </a>
                                                <a href="">
                                                    <img src="../assets/images/social/100/2.jpg"
                                                    alt="" class="img-post display-block-inline"
                                                    />
                                                </a>
                                                <a href="">
                                                    <img src="../assets/images/social/100/3.jpg"
                                                    alt="" class="img-post display-block-inline"
                                                    />
                                                </a>
                                            </div>
                                        ...
                                        <div class="bg-primary">
                                            <div class="media">
                                                <a href="" class="pull-left">
                                                    <img src="../assets/images/people/50/13.jpg"
                                        ...
                                        <div class="collapse" id="comments-collapse">
                                            ...
                                            <div class="media border-bottom margin-none bg-gray">
                                                <a href="" class="pull-left innerAll">
                                                    <img src="../assets/images/people/50/2.jpg"
                                                    width="50" class="media-object">
                                                </a>
                                                <div class="media-body innerTB">
                                                    <a href="#" class="pull-right innerT innerR text-muted">
                                            ...
                                            <div class="media margin-none ">
                                                <a href="" class="pull-left innerAll">
                                                    <img src="../assets/images/people/50/11.jpg"
                                                    width="50" class="media-object">
                                                </a>
                                                <div class="media-body innerTB">
                                    ...
                                    <div class="widget gridalicious-item not-responsive">
                                        ...
                                        <div class="bg-primary">
                                            <div class="media">
                                                <a href="" class="pull-left">
                                                    <img src="../assets/images/people/50/15.jpg"
                                                    width="50" class="media-object">
                                                </a>
                                                <div class="media-body innerTB half">
                                                    <a href="#" class="pull-right innerT innerR text-white">
                                        ...
                                        <div class="media margin-none bg-gray">
                                            <a href="" class="pull-left innerAll">
                                                <img src="../assets/images/people/50/18.jpg"
                                                width="50" class="media-object">
                                            </a>
                                            <div class="media-body innerTB">
                                    ...
                                    <div class="widget gridalicious-item not-responsive">
                                        <div class="media">
                                            <a href="" class="pull-left">
                                                <img src="../assets/images/people/50/3.jpg"
                                                width="50" class="media-object">
                                            </a>
                                            <div class="media-body innerTB half">
                                                <a href="#" class="pull-right innerT innerR text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                        ...
                                        <!-- Content -->
                                        <a href="">
                                            <img src="../assets/images/photodune-2755655-party-time-s.jpg"
                                        ...
                                        <div class="media margin-none">
                                            <a href="" class="pull-left innerAll">
                                                <img src="../assets/images/people/50/5.jpg"
                                                width="50" class="media-object">
                                            </a>
                                            <div class="media-body innerTB">
                                                <a href="#" class="pull-right innerT innerR text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                    ...
                                    <div class="widget gridalicious-item not-responsive">
                                        <a href="">
                                            <img src="../assets/images/photodune-6374531-at-celebration-xs.jpg"
                                            alt="" class="img-responsive">
                                        </a>
                                        <!-- Info -->
                                        <div class="bg-primary">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="widget">
                                <div class="widget-body text-center">
                                    <a href="">
                                        <img src="../assets/images/people/250/22.jpg"
        ...
        <div id="footer" class="hidden-print">
            ...
            <div class="copy">&copy; 2012 - 2014 - <a href="http://www.mosaicpro.biz">MosaicPro</a> -
                ...
                v1.0.1-rc2 / <a target="_blank" href="../assets/../../CHANGELOG.txt?v=v1.0.1-rc2">changelog</a>
            </div>
            <!--  End Copyright Line -->
        </div>
        <!-- // Footer END -->
    ...
    <script src="../assets/components/library/bootstrap/js/bootstrap.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/plugins/nicescroll/jquery.nicescroll.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/plugins/breakpoints/breakpoints.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/plugins/preload/pace/pace.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/plugins/menus/sidr/jquery.sidr.js?v=v1.0.1-rc2"></script>
    <script src="../assets/components/modules/admin/twitter/assets/js/twitter.init.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/plugins/holder/holder.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/common/gallery/gridalicious/assets/lib/jquery.gridalicious.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/common/gallery/gridalicious/assets/custom/gridalicious.init.js?v=v1.0.1-rc2"></script>
    <script src="../assets/components/modules/admin/maps/google/assets/custom/maps-google.init.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="http://maps.googleapis.com/maps/api/js?v=3&sensor=false&callback=initGoogleMaps"></script>
    <script src="../assets/components/modules/admin/modals/assets/js/bootbox.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="../assets/components/core/js/core.init.js?v=v1.0.1-rc2"></script>
</body>
</html>