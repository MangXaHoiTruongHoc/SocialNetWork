...
<head>
	...
	**********************************************************
	<link rel="stylesheet/less" href="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/less/admin/module.admin.stylesheet-complete.less" />
	-->
    <!--[if lt IE 9]><link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/library/bootstrap/css/bootstrap.min.css" /><![endif]-->
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/css/admin/module.admin.stylesheet-complete.min.css"
    />
    ...
    <![endif]-->
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/library/jquery/jquery.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/library/jquery/jquery-migrate.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/library/modernizr/modernizr.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/less-js/less.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/modules/admin/charts/flot/assets/lib/excanvas.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/browser/ie/ie.prototype.polyfill.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script>
...
<body class="">
    ...
    <div class="container-fluid menu-hidden ">
                            ...
                            <li class="conversation innerAll">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-object pull-left">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/50/1.jpg"
                                ...
                                <div class="media primary right">
                                    ...
                                    <div class="media-object pull-right">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/50/2.jpg"
                                        alt="Image" class="img-circle" />
                                    </div>
                                    <div class="media-body">
                                ...
                                <li>
                                    <div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/1.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/2.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/3.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/4.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-1 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/5.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/6.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/7.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/8.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/9.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-2 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/10.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/11.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/12.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/13.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/14.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class="mixit-chat-3 mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/15.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                                    ...
                                    <div class=" mix media border-bottom innerAll margin-none">
                                        <a href="#chat-conversation" data-toggle="tab" class="pull-left media-object">
                                            <img src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/35/16.jpg"
                                            class="img-circle" />
                                        </a>
                                        <div class="media-body">
                                            <a href="#chat-conversation" data-toggle="tab" class="pull-right text-muted innerT half">
                        ...
                        <ul class="dropdown-menu chat media-list">
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumb" src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/100/15.jpg"
                                    alt="50x50" width="50" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumb" src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/100/16.jpg"
                                    alt="50x50" width="50" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumb" src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/images/people/100/17.jpg"
                                    alt="50x50" width="50" />
                                </a>
                                <div class="media-body">
        ...
        <div id="footer" class="hidden-print">
            ...
            <div class="copy">&copy; 2012 - 2014 - <a href="http://www.mosaicpro.biz">MosaicPro</a> -
                ...
                v1.0.1-rc2 / <a target="_blank" href="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/<?php echo Yii::app()->request->baseUrl; ?>/CHANGELOG.txt?v=v1.0.1-rc2">changelog</a>
            </div>
            <!--  End Copyright Line -->
        </div>
        <!-- // Footer END -->
    ...
    var App = {};
    var basePath = '../',
        commonPath = '<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/',
        rootPath = '<?php echo Yii::app()->request->baseUrl; ?>/',
        DEV = false,
        componentsPath = '<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/';
    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/library/bootstrap/js/bootstrap.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/nicescroll/jquery.nicescroll.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/breakpoints/breakpoints.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/preload/pace/pace.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/menus/sidr/jquery.sidr.js?v=v1.0.1-rc2"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/core/js/sidebar.main.init.js?v=v1.0.1-rc2"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/core/js/sidebar.collapse.init.js?v=v1.0.1-rc2"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/common/forms/elements/bootstrap-select/assets/lib/js/bootstrap-select.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/common/forms/elements/bootstrap-select/assets/custom/js/bootstrap-select.init.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/modules/admin/menus/menus.sidebar.chat.init.js?v=v1.0.1-rc2"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/mixitup/jquery.mixitup.min.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/plugins/mixitup/mixitup.init.js?v=v1.0.1-rc2&sv=v0.0.1.1"></script>
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/themes/assets/components/core/js/core.init.js?v=v1.0.1-rc2"></script>
</body>
</html>