...
//        $('#abc". $model->pf_ma_tn."').mouseenter(function(){
...
<div class="re_up<?php echo($model->pf_ma_tn) ?>" style="display: display;">
...
echo CHtml::ajaxLink('Delete',
                Yii::app()->createUrl('pf_totnghiep/delete&id='.$model->pf_ma_tn),
                array(
                                'type'=>'post',
                                'data' => array('id' =>$model->pf_ma_tn,'type'=>'delete'),
                                'update'=>'message',
